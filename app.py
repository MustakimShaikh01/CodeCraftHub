...
# Built with Flask for learning REST API basics.
...
def stats():
    courses = load_courses()
    stats = {"total": len(courses), "Not Started": 0, "In Progress": 0, "Completed": 0}
...
if __name__ == "__main__":
    print("CodeCraftHub API running at http://localhost:5000")
    app.run(debug=True)
